...
class Project:
    ...
    def get_latest_version(self, loaders: list[str] | None = ..., game_versions: list[str] | None = ..., featured: bool | None = ..., types: _literals.version_type_literal | None = ..., auth: str | None = ...) -> Project.Version: ...
    @property
    ...
    def get_specific_version(self, semantic_version: str) -> _typing.Optional['Project.Version']: ...
    def download(self, recursive: bool = ...) -> None: ...
    def get_versions(self, loaders: list[str] | None = ..., game_versions: list[str] | None = ..., featured: bool | None = ..., types: _literals.version_type_literal | None = ..., auth: str | None = ...) -> list['Project.Version']: ...
    def get_oldest_version(self, loaders: list[str] | None = ..., game_versions: list[str] | None = ..., featured: bool | None = ..., types: _literals.version_type_literal | None = ..., auth: str | None = ...) -> Project.Version: ...
    @property
    def id(self) -> str: ...
    @property
    def slug(self) -> str: ...
    ...
    def modify(self, slug: str | None = ..., title: str | None = ..., description: str | None = ..., categories: list[str] | None = ..., client_side: str | None = ..., server_side: str | None = ..., body: str | None = ..., additional_categories: list[str] | None = ..., issues_url: str | None = ..., source_url: str | None = ..., wiki_url: str | None = ..., discord_url: str | None = ..., license_id: str | None = ..., license_url: str | None = ..., status: _literals.project_status_literal | None = ..., requested_status: _literals.requested_project_status_literal | None = ..., moderation_message: str | None = ..., moderation_message_body: str | None = ..., auth: str | None = ...) -> bool: ...
    def delete(self, auth: str | None = ...) -> _typing.Literal[True]: ...
    @property
    def dependencies(self) -> list['Project']: ...
    @staticmethod
    def search(query: str = ..., facets: list[list[str]] | None = ..., index: _literals.index_literal = ..., offset: int = ..., limit: int = ..., filters: list[str] | None = ...) -> list['Project._SearchResult']: ...
    @property
    ...
    class Version:
        ...
        @staticmethod
        def get_from_hash(hash_: str, algorithm: _literals.sha_algorithm_literal = ..., multiple: bool = ...) -> _typing.Union['Project.Version', list['Project.Version']]: ...
        @staticmethod
        def delete_file_from_hash(auth: str, hash_: str, version_id: str, algorithm: _literals.sha_algorithm_literal = ...) -> _typing.Literal[True]: ...
        @property
