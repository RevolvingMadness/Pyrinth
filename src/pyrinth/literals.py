...
dependency_type_literal = _typing.Literal[
    "required", "optional", "incompatible", "embedded"
]
loader_literal = _typing.Literal[
    "fabric", "forge", "liteloader", "modloader", "quilt", "rift", "datapack"
]
game_version_literal = _typing.Literal[
    "23w13a",
    "23w12a",
    "1.19.4",
    "1.19.4-rc3",
